...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/cn.search-data.min.08f21606eae4a4dabfda702d8c697750710adb548080eda3e855737bc4a273d5.js',function(){input.required=false;search();});}
