...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/cn.search-data.min.4ef6917b942770fd3415e3c2db0804a75cd526d9eba216ee902edc68ccc1b36d.js',function(){input.required=false;search();});}
